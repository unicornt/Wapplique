(module
  ...
  (func (;2;) (type 5)
    ...
    i32.store)
  (func (;3;) (type 5)
    (local f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64)
    call 2
    global.get 0
    i32.const 16
    i32.sub
    ...
    call 0
    unreachable)
  (func (;4;) (type 8) (param i32 i32 f64)
    (local f64 f64)
    local.get 0
    local.get 2
    local.get 2
  ...
  (data (;16;) (i32.const 1572) "\03\00\00\00\04\00\00\00\b8\06\00\00\00\04")
