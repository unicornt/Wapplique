(module
  ...
  (func (;2;) (type 3)
    ...
    i32.store)
  (func (;3;) (type 3)
    (local f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32)
    call 2
    global.get 0
    i32.const 32
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00nan\00inf\00   Module     Error        RunTime      MFLOPS\00NAN\00INF\00.\00(null)\00                            (usec)\00     5   %13.4lf  %10.4lf  %10.4lf\0a\00   FLOPS C Program (Double Precision), V2.0 18 Dec 1992\0a")
