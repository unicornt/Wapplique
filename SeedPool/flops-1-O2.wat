(module
  ...
  (func (;2;) (type 3)
    ...
    i32.store)
  (func (;3;) (type 3)
    (local i32 i32 i32 i32 i32 i32 i32 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64)
    call 2
    global.get 0
    i32.const 32
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00nan\00inf\00   Module     Error        RunTime      MFLOPS\00NAN\00INF\00.\00(null)\00                            (usec)\00     1   %13.4lf  %10.4lf  %10.4lf\0a\00   FLOPS C Program (Double Precision), V2.0 18 Dec 1992\0a")
  ...
  (data (;14;) (i32.const 1744) "t\83\13C\e1z\a4?i\1dUM\10uO?(\a7\f4\0fZ\b0\b4>i\1dUM\10u??\8a\89\9bj\cd\95\9b>\05")
  (data (;15;) (i32.const 1796) "\02")
  (data (;16;) (i32.const 1820) "\03\00\00\00\04\00\00\00\e8\09\00\00\00\04")
  (data (;17;) (i32.const 1844) "\01")
  (data (;18;) (i32.const 1860) "\ff\ff\ff\ff\0a")
  (data (;19;) (i32.const 1928) "\f8\06"))
