(module
  ...
  (func (;19;) (type 0) (param i32) (result i32)
    ...
    i32.store
    i32.const -1)
  (func (;20;) (type 9) (param i32 i32) (result i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      i32.const 0
  ...
  (elem (;0;) (i32.const 1) func 2 6 10 11)
  (data (;0;) (i32.const 1024) "-+   0X0x\00 Error in Tree.\00(null)\00%d\0a")
  ...
  (data (;16;) (i32.const 1588) "\03\00\00\00\04\00\00\00\08U\00\00\00\04")
  (data (;17;) (i32.const 1612) "\01")
  (data (;18;) (i32.const 1628) "\ff\ff\ff\ff\0a")
  (data (;19;) (i32.const 1696) "\10\06\00\00\c0[\01"))
