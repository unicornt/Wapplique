(module
  ...
  (func (;2;) (type 3)
    ...
    i32.store)
  (func (;3;) (type 3)
    (local f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    i32.const 1848
    i32.const 1728
    i32.store
    i32.const 1776
  ...
  (func (;11;) (type 6) (param i32 i64 i32) (result i64)
    i64.const 0)
  (func (;12;) (type 8) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func (;16;) (type 9) (param i32 i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;17;) (type 10) (param i32 i32) (result i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      i32.const 0
