(module
  ...
  (func (;20;) (type 11) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func (;21;) (type 12) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 256
    i32.sub
    ...
    i32.add
    global.set 0)
  (func (;22;) (type 13) (param i32 f64 i32 i32 i32 i32) (result i32)
  ...
  (elem (;0;) (i32.const 1) func 4 9 10 11 22)
