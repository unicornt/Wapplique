(module
  ...
  (func (;4;) (type 6)
    ...
    i32.store)
  (func (;5;) (type 6)
    (local i32 i32 i32 i32 i32 i32 i32 i32 f32 f32 f32 f64 f64)
    i32.const 2944
    i32.const 2824
    i32.store
    i32.const 2872
  ...
  (data (;0;) (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00nan\00inf\00NAN\00INF\00.\00(null)\00Total is %g\0a")
  ...
  (data (;16;) (i32.const 1620) "\03\00\00\00\04\00\00\00\d8\06\00\00\00\04")
