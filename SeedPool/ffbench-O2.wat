(module
  ...
  (func (;5;) (type 9) (param i32 i32)
    (local f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    local.get 1
    f64.convert_i32_s
  ...
  (func (;21;) (type 0) (param i32) (result i32)
    ...
    i32.const 10
    i32.lt_u)
  (func (;22;) (type 14) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func (;26;) (type 15) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 256
    i32.sub
  ...
  (data (;18;) (i32.const 4580) "\03\00\00\00\04\00\00\00|\12")
