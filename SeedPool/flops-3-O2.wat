(module
  ...
  (func (;2;) (type 3)
    ...
    i32.store)
  (func (;3;) (type 3)
    (local f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32)
    call 2
    global.get 0
    i32.const 32
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00nan\00inf\00   Module     Error        RunTime      MFLOPS\00NAN\00INF\00.\00(null)\00                            (usec)\00     3   %13.4lf  %10.4lf  %10.4lf\0a\00   FLOPS C Program (Double Precision), V2.0 18 Dec 1992\0a")
  ...
  (data (;14;) (i32.const 1744) "\05\97UUUU\c5\bf\a3\e9:\11\11\11\81?q\ca\b1?\a0\01*?f5\aa\84\f2\1d\c7>&\a4\f8\8cZ\ebZ>\a6\c1)R\f7\8d\e6=\05")
  (data (;15;) (i32.const 1804) "\02")
  (data (;16;) (i32.const 1828) "\03\00\00\00\04\00\00\00\d8\08\00\00\00\04")
  (data (;17;) (i32.const 1852) "\01")
  (data (;18;) (i32.const 1868) "\ff\ff\ff\ff\0a")
  (data (;19;) (i32.const 1937) "\07"))
